...
//  differe from each other. otherwise all are same..
...
// this is second cjild class. which are protecticaly inhareted from class Age
...
{
	fullAge<float> objName;
	objName.setDate_for_Age();
	objName.DisplayDateBirth();
	objName.set_NewDate_for_Age();
	objName.DisplayNewDate();
	objName.calculation();
	objName.DisplayAge();
}
int main()
