...
void days(int year,int munth,int days){
		for(int i=2000; i<=2010;i++){
	     if(i==year){
	     	cout<<"This is yuor Number: 2000 /"<<i;
	     	break;
			}else{
				i++;
			}
		if(i==year){
			cout<<"This is yuor Number:2001 / "<<i;
			break;
			}else{
				i++;
			}
			if(i==year){
				cout<<"This is yuor Number:2002 / "<<i;
				break;
	}else{
		i++;
	}
	 ...
	 if(i==year){
		cout<<"This is your Number: 2003 /"<<i;
	}
}
}
