...
// My 2nd main function
void days(int year, int month, int days)
{
...
int main()
{
	...
	cout << "Enter Your Date of Born:........" << endl;
	cout << "Enter year: ";
	cin >> yeari;
	if (yeari < 1950)
	{
	...
	{
		cout << "The value is greater than 2022 You never Born in this year this is not possible " << yeari;
		return 2022;
	}
	else
	{
	...
	if (monthi < 1)
	{
		cout << "Sorry your are wrong this is month...\n I Never saw that Month is (0)";
		return 1;
	}
	else if (monthi > 12)
	{
		cout << "Sorry this is month you enter " << monthi << " month.\n You Know that Month is never greater than 12";
		return 12;
	}
	else
	{
	...
	if (yearf < 2000)
	{
		cout << "Sorry the value is incorract please corract the value first...\n I Calculate only year is greater than 2000";
		return 2000;
	}
	else if (yearf > 2024)
	{
		cout << "The value is very big we have not calculate this value sorry...";
		return 2024;
	}
	else
	{
	...
	{
		cout << "Sorry this is month you enter " << monthf << " month";
		return 12;
	}
	else
	{
	...
	// Showing month ...
	cout << "_-----------------------------------------------------------|  Month  |  days  | years " << endl;
	cout << "----------------------Your Date of Barth is here------------| ";
	month(monthi);
	cout << " | ";
	days(yeari, monthi, dayi);
	cout << " | ";
	cout << yeari << endl;
	cout << "--------------------------New Date is here------------------| ";
	month(monthf);
	cout << " | ";
	//	showinh days ...
	days(yearf, monthf, dayf);
	cout << " | ";
	cout << yearf << endl;
	// Calculation..................................................
	float year = 365.25, month = 30.4375, deffrence_of_year = (yearf - yeari) * year;
	float deffrence_of_month = (monthf - monthi) * month;
	...
	float net_months = net_days / month;
	cout << "Net months of your Age is : " << net_months << endl;
